...
<nav class="navbar navbar-expand-lg navbar-light bg-light navBar">
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
      	<spring:url value="/student/create" var="create" htmlEscape="true"/>
        <a class="nav-link" href="${create}">Create</a>
      </li>
      <li class="nav-item">
      	<spring:url value="/student/update" var="update" htmlEscape="true"/>
        <a class="nav-link" href="${update}">Update</a>
      </li>
      <li class="nav-item">
      	<spring:url value="/student/showAll" var="showAll" htmlEscape="true"/>
        <a class="nav-link" href="${showAll}">Show All</a>
      </li>
      <li class="nav-item">
      	<spring:url value="/student/getById" var="getById" htmlEscape="true"/>
        <a class="nav-link" href="${getById}">Get By Id</a>
      </li>
      <li class="nav-item">
      	<spring:url value="/student/delete" var="delete" htmlEscape="true"/>
