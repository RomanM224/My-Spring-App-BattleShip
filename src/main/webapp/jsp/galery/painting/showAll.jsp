        ...
        <div class="row">
            <div class="col-12 align-self-center mt-4">
                ...
                <a href="<%out.print(urlName);%>?pageId=<%out.print(i);%>">
                    <button type="button" class="btn btn-light pageNavBtn">
                        <%out.print(num1 + " - " + num2);%>
                    </button>
                </a>
                <%
                ...
                %>
                <a href="<%out.print(urlName);%>?pageId=<%out.print(i);%>">
                    <button type="button" class="btn btn-dark pageNavBtn">
                        <%out.print(num1 + " - " + num2);%>
                    </button>
                </a>
                <%
        ...
        <div class="row  justify-content-around">
            ...
            <div class="col-lg-5 col-md-12 mb-4">
                <div class="card my-3 myCard">
                    <img alt="img" class="card-img-top painting"
                        src="data:image/jpeg;base64,<%out.println(painting.getImageBase64Encoded());%>" />
                    <div class="card-body card-bg-color">
                        ...
                        <p class="card-text">
                            <b>Painter: </b>
                            <%
                            out.print(painterNames.get(painting.getId()));
                            %>
                        </p>
                        <p class="card-text">
                            <b>Style: </b>
                            <%
                            out.print(painting.getStyle().getStyle());
                            %>
                        </p>
                        <p class="card-text">
                            <b>Year: </b>
                            <%
                            out.print(painting.getYear());
                            %>
                        </p>
                    </div>
                </div>
