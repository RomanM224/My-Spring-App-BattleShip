...
<body class="bg-image-galery" style="background-image: url('${galery_background}');">
    ...
    <div class="container mt-2">
        <form action="../painting/updateFullPaintingInfo" method="post" enctype="multipart/form-data">
            <div class="form-group col-xl-6 col-lg-8 col-12 row mt-5">
                <label for="painting" class="col-sm-4 col-form-label">
                    <b>Select painting: </b>
                </label>
                <div class="col-sm-12">
                    <select
                        class="form-control <%if (info != null && info.equals("Painting not exist")) {
    out.print("is-invalid");
                        ...
                        %>
                        <option value=<%out.print("\"" + painting.getId() + "\"");%>>
                            <%
                            out.print(painting.getName());
                            %>
                        </option>
                        <%
                        }
                ...
                <label for="name" class="col-sm-12 col-form-label mt-3">
                    <b>Input Painting name: </b>
                </label>
                <div class="col-sm-12 mt-3">
                    <input
                        class="form-control <%if (info != null && info.equals("Painting Name is invalid")) {
    out.print("is-invalid");
}%>"
                        id="name" type="text" name="name" />
                </div>

                <label for="painting" class="col-sm-4 col-form-label mt-3">
                    <b>Select Style: </b>
                </label>
                ...
                <label for="year" class="col-sm-4 col-form-label mt-3">
                    <b>Input Painting year: </b>
                </label>
                <div class="col-sm-8 mt-3">
                    <input
                        class="form-control <%if (info != null && info.equals("Year is invalid")) {
    out.print("is-invalid");
}%>"
                        id="year" type="number" name="year" />
                </div>

                <label for="file" class="col-sm-4 col-form-label mt-3">
                    <b>Chose Painting: </b>
                </label>
                <div class="col-sm-8 mt-3">
                ...
                <label for="painter" class="col-sm-4 col-form-label mt-3">
                    <b>Select Painter: </b>
                </label>
                <div class="col-sm-8 mt-3">
                    <select
                        class="form-control <%if (info != null && info.equals("Painter not exist")) {
    out.print("is-invalid");
}%>"
                        id="painter" name="painterId">
                        <%
                        for (Painter painter : painters) {
                        %>
                        <option value=<%out.print("\"" + painter.getId() + "\"");%>>
                            <%
                            out.print(painter.getFullName());
                            %>
                        </option>
                        <%
                        }
        ...
        if (info != null) {
        %>
        <p class="container m-2 text-danger">
            <b>
                <%
                out.print(info);
                %>
