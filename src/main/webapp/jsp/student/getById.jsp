...
<body>
	...
	<div class="container m-2">
		<form class="form-group" action="../student/getById" method="post">
			<label for="firstName">Find Student by id: </label> 
			<input class="form-control col-3" id="id" type="number" name="id" />
			<input class="btn btn-primary mt-2" type="submit" value="Find Student" />
		</form>
	</div>
